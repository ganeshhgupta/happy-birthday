  ...
  var y,
    ...
    g = {
      init: function (a) {
        ...
        this.css({ position: "relative", width: a.width, height: window.innerHeight });
      ...
      size: function (a, b) {
        if (void 0 === a || void 0 === b)
          return { width: this.width(), height: window.innerHeight };
        this.turn("stop");
        var c,
          d,
          e = this.data();
        d = "double" == e.display ? a / 2 : a;
        this.css({ width: a, height: window.innerHeight });
        b = window.innerHeight; // Force b to be full height
      ...
      _updateShadow: function () {
        var a,
          ...
          c = this.data(),
          d = this.width(),
          e = window.innerHeight,  // Force full viewport height
        ...
        switch (b.effect) {
          ...
          case "sheet":
            ...
            var N = c.opts.acceleration,
              ...
              f = function (a, d, f, g) {
                var k = ["0", "auto"],
                  m = ((e - window.innerHeight) * f[0]) / 100,
                  l = 0, // Force vertical offset to 0 to prevent gaps
                  d = {
                    left: k[d[0]],
                    top: "0px", // Force top to 0 instead of using k[d[1]]
                    right: k[d[2]], 
                    bottom: "0px", // Force bottom to 0 instead of using k[d[3]]
                  },
                  k = {},
                  n = 90 != g && -90 != g ? (B ? -1 : 1) : 0,
                  r = f[0] + "% " + f[1] + "%";
                  ...
                  .transform(
                    F(g) +
                      E(
                        ...
                        a.y + P.y - u.y, // Remove height-based calculation 
                        N
                      ) +
                      F((180 / g - 2) * g),
                    r
                ...
                b.wrapper.transform(E(-a.x + m - n, -a.y, N) + F(-g), r); // Remove l from vertical offset
                
                b.fwrapper.transform(
                  E(-a.x + u.x + m, -a.y + u.y, N) + F(-g), // Remove l from vertical offset
                  r
                );
                
                // Keep the gradient section unchanged
                c.opts.gradients &&
                  (f[0] && (z.x = 100 - z.x),
                  f[1] && (z.y = 100 - z.y),
